/*
Pie directive to draw pie graph using nvd3.js.
Isolate scope bindings used.
*/
myApp.directive('pieChart', ['d3Test', 'nvTest', function(d3Test, nvTest) {
  return {
    ...
    link: function(scope, element) {
      ...
      //Update Function to call  draw function
      function update() {
      ...
      scope.$watch(function() {
        return angular.toJson(scope.pie);
      }, function() {
        if (chart2) {
          update();
        }
      ...
      //Draw Chart    
        nv.addGraph(
        function() {
        chart2 = nv.models.pieChart().x(function(d) {
          return d.label
        }).y(function(d) {
          return d.value
        }).showLegend(false).showLabels(true).labelType("percent");
