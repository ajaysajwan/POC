...
3.  Zingchart-angularjs directive Details:
...
5.  Customized functionality: 
    ...
    *   Change the value of perticular node at run time: Click on any node, and enter the new value in the text box. we can change its value at run time.
